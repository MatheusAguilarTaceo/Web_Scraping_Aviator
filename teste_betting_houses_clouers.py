...
#     with Pool(2) as p:
#         p.starmap(bettingHouse, [[houseB2xbet, '2bxbet_2023'], [houseGoldebet, 'goldebet_2023']])

try:
    goldebet = bettingHouse(houseB2xbet,'b2xbet_2023')
except Exception as error:
    print('Erro gerado  = ', error)

# try:
#     b2xbet = bettingHouse(houseB2xbet, 'b2xbet_2023')
# except Exception as error:
#     print('Erro gerado = ', error)
